...
# @a2ml-metadata begin
# (
#   id                   = "cerro-torre-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "cerro-torre"
#   app-display          = "Cerro Torre"
#   app-url              = ""
...
#
# ============================================================================
# cerro-torre-launcher.sh — Cerro Torre
# ============================================================================
# GENERATED by launch-scaffolder from cerro-torre.launcher.a2ml.
...
APP_NAME="cerro-torre"
APP_DISPLAY="Cerro Torre"
APP_DESC="Application"
APP_CATEGORIES="Development;"
APP_GENERIC_NAME="Cerro Torre"
...
PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/cerro-torre.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/cerro-torre/cerro-torre.log"

# Search list from [runtime].startup-command-search — first executable wins.
START_COMMAND=""
for candidate in \
    "/target/release/cerro-sign" \
    "/cerro-sign" \
    "cerro-sign" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in cerro-torre.launcher.a2ml."
            return 1
        fi
    fi
